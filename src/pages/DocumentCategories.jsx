...
export default function DocumentCategories() {
  ...
  const handleSearch = async () => {
    ...
    const res = await searchDocumentCategories(params)
    if (res.status == 200) {
  ...
  const save = async () => {
    if (editing) {
      await updateDocumentCategory(editing.id, form)
    } else {
      await createDocumentCategory(form)
    }
    setOpen(false)
    load()
  }
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-semibold">DocumentCategories</h2>
        ...
        <table className="table w-full">
          ...
          <tbody>
            ...
            {documentCategories.length === 0 && (
              <tr>
                <td colSpan="6" className="text-center text-gray-500 py-4">No documentCategories found</td>
              </tr>
            )}
          </tbody>
        </table>
     ...
     {/* Pagination Controls */}
      ...
      {open && (
        <Modal
          title={editing ? 'Edit Document Category' : 'New DocumentCategory'}
          ...
          <div className="space-y-3">
              ...
              <div className="flex justify-end">
                <button
                    ...
                    title="Save DocumentCategory Data"
                  >
